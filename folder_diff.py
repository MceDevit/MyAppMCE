...
def generate_pdf_report(copied_files, folder_a, folder_b, output_path):
    ...
    doc = SimpleDocTemplate(
        ...
        title="Folder Compare — Copy Report"
    )
    ...
    story.append(Paragraph("Folder Compare", title_s))
    ...
    story.append(Paragraph("Generated by Folder Compare  •  A comparison and sync tool.", note_s))
...
class FolderDiffApp(tk.Tk):
    def __init__(self):
        ...
        try:
            ...
            app_menu.add_command(label="About Folder Compare")
            app_menu.add_separator()
            app_menu.add_command(label="Quit Folder Compare",
    ...
    def _build_ui(self):
        ...
        tk.Label(hdr, text="⇄  Folder Compare",
